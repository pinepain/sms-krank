...
class Gsm implements CharsetInterface
{
    protected $options;
    ...
    public function is($string)
    {
        ...
        $regex = '/[^\x{0A}\x{0C}\x{0D}\x{20}-\x{5F}\x{61}-\x{7E}\x{1B}£¥èéùìòÇØøÅåΔ_ΦΓΛΩΠΨΣΘΞÆæßÉ¤¡ÄÖÑÜ§¿äöñüà€]/u';
    ...
    public function normalize($string)
    {
        ...
        /
          (
            (?:
              [\x{0A}\x{0C}\x{0D}\x{20}-\x{5F}\x{61}-\x{7E}\x{1B}£¥èéùìòÇØøÅå∆_ΦΓΛΩΠΨΣΘΞÆæßÉ¤¡ÄÖÑÜ§¿äöñüà€] # GSM characters
    ...
    protected function escape($string)
    {
        ...
        $string = preg_replace('/([\x{0C}^{}\\\\\[~\]\|€])/u', '☮${1}', $string);
